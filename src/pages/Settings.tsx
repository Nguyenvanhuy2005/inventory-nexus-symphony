...
import ApiConnectionGuide from "@/components/settings/ApiConnectionGuide";
import DatabaseApiInfo from "@/components/settings/DatabaseApiInfo";
...
export default function Settings() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="api-credentials">
        <TabsList className="w-full">
          <TabsTrigger value="api-credentials" className="flex-1">Thông tin xác thực API</TabsTrigger>
          <TabsTrigger value="database-api" className="flex-1">Database API</TabsTrigger>
          <TabsTrigger value="connection-test" className="flex-1">Kiểm tra kết nối</TabsTrigger>
          <TabsTrigger value="guides" className="flex-1">Hướng dẫn</TabsTrigger>
        </TabsList>

        <TabsContent value="api-credentials" className="space-y-4 mt-4">
        ...
        <TabsContent value="database-api" className="mt-4">
          <DatabaseApiInfo />
        </TabsContent>

        <TabsContent value="connection-test" className="mt-4">
          <ApiConnectionTester />
        </TabsContent>
